...
export const SETTINGS_DEFINITIONS: SettingDefinition[] = [
  ...
  },
  {
    ...
    description: 'Jupiter aggregator API base endpoint (default: api.jup.ag/swap/v1)',
    defaultValue: 'https://api.jup.ag/swap/v1',
  ...
  },
  {
    ...
    description: 'API key from station.jup.ag/api-keys (required, free tier: 1 req/sec)',
    defaultValue: '',
