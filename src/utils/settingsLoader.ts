...
export async function initializeDefaultSettings(): Promise<void> {
  try {
    ...
    const defaults = [
      ...
      { key: 'JUPITER_API_URL', value: 'https://api.jup.ag/swap/v1', type: 'string', description: 'Jupiter API URL (swap/v1 endpoint)' },
      { key: 'JUPITER_API_KEY', value: '', type: 'string', description: 'Jupiter API key (get free at https://station.jup.ag/api-keys)', encrypt: false },
